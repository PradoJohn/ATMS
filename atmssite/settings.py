"""
Django settings for atmssite project.
...
SECRET_KEY = 'django-insecure-48o-3$_m97kp%bgc54(h7&z9yf@ljpp!+^xilmio$n$-a@_%*#'
...
WSGI_APPLICATION = 'atmssite.wsgi.application'
